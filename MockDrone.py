...
def single_fly_straight_flight(x, y, z, speed=60):
    state_x = x
    state_y = y
    state_z = z
    print(f"---MOCK_DRONE---single_fly_straight_flight({state_x}, {state_y}, {state_z}, {speed})")
